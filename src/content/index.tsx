...
const workExperience = {
  experiences: [
    ...
    },
    {
      ...
      type: "Full-time",
      achievements: [
        "Engineered automated AI checkout systems using GraphQL federation for major telecom partners, processing over 1,000 daily transactions.",
        ...
        "Enhanced system observability by implementing New Relic flow-tracking instrumentation for reliable operations.",
      ],
      tags: [],
      images: [],
    },
