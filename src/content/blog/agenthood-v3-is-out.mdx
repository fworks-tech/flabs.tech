...
tag: "AI"
tags: ['ai', 'agents', 'showdev', 'machinelearning']
shareText: |
...
devtoId: 4438819
devtoUrl: "https://dev.to/flabstech/agenthood-v300-m5-intelligence-is-shipped-27on"
---
...
for all current members — adding a new one auto-generates its triggers.
...
- **OpenCode Go** — subscription tier at `api.opencode.ai/zen/go/v1`,
  defaults to `mimo-v2.5` ($0.14 / $0.28 per 1M tokens)
